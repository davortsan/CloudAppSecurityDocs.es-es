...
description: En este artículo se describen las direcciones IP y los puertos que se deben abrir para trabajar con Cloud App Security.
keywords: ''
author: shsagir
ms.author: shsagir
manager: shsagir
...
## <a name="view-your-data-center"></a>Visualización del centro de datos

Algunos de los requisitos siguientes dependen del centro de datos al que está conectado.

Para ver el centro de datos al que se está conectando, realice los pasos siguientes:

1. En el portal de Cloud App Security, haga clic en el **icono de signo de interrogación** en la barra de menús. A continuación, seleccione **acerca de**.

    ![Haga clic en acerca de](media/about-menu.png)

2. En la pantalla Cloud App Security versión, puede ver la región y el centro de datos.

    ![Visualización del centro de datos](media/data-center.png)
...
Además, los siguientes elementos deben estar en la lista de permitidos, según el centro de datos que use:
...
> |EE. UU. 2|13.80.125.22<br />20.36.222.59<br />20.36.222.60<br />40.74.1.235<br />40.74.6.204<br />51.143.58.207<br />52.137.89.147<br />52.183.75.62<br />52.184.165.82|\*. us2.portal.cloudappsecurity.com|
...
> [!NOTE]
> En lugar de un carácter comodín (\*) solo se puede abrir la dirección URL de inquilino específica, por ejemplo, en la captura de pantalla anterior, puede abrir: mod244533.us.portal.cloudappsecurity.com
...
> |EE. UU. 2|13.80.125.22<br />20.36.222.59<br />20.36.222.60<br />40.74.1.235<br />40.74.6.204<br />51.143.58.207<br />52.137.89.147<br />52.183.75.62<br />52.184.165.82|
...
> [!NOTE]
> Si no especificó un proxy al configurar el agente de SIEM de Cloud App Security, debe permitir que las conexiones http http://ocsp.msocsp.com/ y ocsp.digicert.com en el puerto 80. Se usa para comprobar el estado de revocación de certificados al conectarse al portal de Cloud App Security.

## <a name="app-connector"></a>Conector de aplicaciones

Para tener acceso a algunas aplicaciones de terceros a través de Cloud App Security, se pueden usar estas direcciones IP. Las direcciones IP permiten a Cloud App Security recopilar registros y proporcionar acceso para la consola de Cloud App Security.

> [!NOTE]
>Puede ver estas direcciones IP en los registros de actividad del proveedor porque Cloud App Security realiza acciones de gobierno y análisis desde estas direcciones IP.

Para conectarse a aplicaciones de terceros, habilite Cloud App Security para conectarse desde estas direcciones IP:
...
> |EE. UU. 2|13.68.76.47<br />20.36.222.59<br />20.36.222.60<br />40.67.152.91<br />40.67.154.160<br />40.67.155.146<br />40.67.159.55<br />40.84.2.83<br />40.84.4.119<br />40.84.4.93|52.184.165.82<br />52.232.224.227<br />52.232.225.84<br />104.46.116.211<br />104.46.116.211<br />104.46.121.72<br />104.46.121.72<br />104.46.122.189<br />104.42.54.148<br />104.46.122.189<br />|
...
Para habilitar Cloud App Security para enviar datos a través de su stunnel al servidor ICAP, abra el Firewall de la red perimetral en estas direcciones IP con un número de puerto de origen dinámico.

1. **Direcciones de origen** : estas direcciones deben incluirse en la lista de permitidos para las aplicaciones de terceros del conector de API.
2. **Puerto TCP de origen** : dinámico
3. **Direcciones de destino** : una o dos direcciones IP de Stunnel conectadas al servidor ICAP externo
4. **Puerto TCP de destino** : tal y como se define en la red

> [!NOTE]
>
> - El número de puerto de Stunnel está establecido de forma predeterminada en 11344. Puede cambiarlo a otro puerto si es necesario, pero asegúrese de anotar el nuevo número de puerto.
> - Puede ver estas direcciones IP en los registros de actividad del proveedor porque Cloud App Security realiza acciones de gobierno y análisis desde estas direcciones IP.

Para conectarse a aplicaciones de terceros e integrarse con soluciones DLP externas, habilite Cloud App Security para conectarse desde estas direcciones IP:
...
> |EE. UU. 2|20.36.222.59<br />20.36.222.60<br />40.67.152.91<br />40.67.154.160<br />40.67.155.146<br />40.67.159.55<br />40.84.2.83<br />40.84.4.119<br />40.84.4.93|52.184.165.82<br />52.232.224.227<br />52.232.225.84<br />104.46.116.211<br />104.46.116.211<br />104.46.121.72<br />104.46.121.72<br />104.46.122.189<br />104.46.122.189|
...
Para habilitar las notificaciones para que se envíen desde la plantilla y la configuración predeterminadas, agregue estas direcciones IP a la lista de permitidos de anti-spam. Las direcciones IP de correo electrónico dedicadas Cloud App Security son:
...
Para habilitar Cloud Discovery características mediante un compilador de registros y detectar sombras en la organización, abra los siguientes elementos:
...
- Permita que el recopilador de registros inicie el tráfico saliente a Azure BLOB Storage en el puerto 443:

  | Centro de datos |                        URL                                 |
  |-------------|------------------------------------------------------------|
  |     Estados Unidos 1     | https:\//adaprodconsole.blob.core.windows.net/             |
  |     EE. UU. 2     | https:\//prod03use2console1.blob.core.windows.net/         |
...
>- Permita que el recopilador de registros inicie el tráfico saliente en el portal de Cloud App Security.
>- Si no especificó un proxy al configurar el recopilador de registros, debe permitir que las conexiones http http://ocsp.msocsp.com/ y ocsp.digicert.com en el puerto 80. Se usa para comprobar el estado de revocación de certificados al conectarse al portal de Cloud App Security.
