---
title: 'Directivas de protección de la información: Cloud App Security'
...
- La [integración de Azure Information Protection (AIP)](azip-integration.md) está habilitada y la etiqueta RGPD está configurada en AIP.
