...
| Encabezados de seguridad HTTP: STRICT-Transport-Security | Seguridad | Boolean | True, False | ¿Son los encabezados HTTP STRICT-Transport-Security implementados por la aplicación en su sitio web? |
| Encabezados de seguridad HTTP: Content-Security-Policy | Seguridad | Boolean | True, False | ¿Son los encabezados HTTP Content-Security-Policy implementados por la aplicación en su sitio web? |
...
| Encabezados de seguridad HTTP: X-XSS-Protection | Seguridad | Boolean | True, False | ¿Son los encabezados HTTP X-XSS-Protection implementados por la aplicación en su sitio web? |
