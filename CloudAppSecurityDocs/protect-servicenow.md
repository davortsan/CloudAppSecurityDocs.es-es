...
La conexión de ServiceNow a Cloud App Security le proporciona información más detallada sobre las actividades de los usuarios, proporciona detección de amenazas mediante detecciones de anomalías basadas en aprendizaje automático y detecciones de protección de la información, como la identificación cuando el cliente confidencial la información se carga en la nube de ServiceNow.
