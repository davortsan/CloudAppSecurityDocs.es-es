...
> - Si está integrando mediante la integración de Azure Information Protection, consulte [Integración de Azure Information Protection](azip-integration.md) para obtener información. 
