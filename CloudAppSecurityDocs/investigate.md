---
title: Investigación de riesgos de las aplicaciones en la nube y actividad sospechosa
...
|Panel de la aplicación: información general|Información general del uso de la aplicación por ubicación, gráficos de uso por número de usuarios.|
|Panel de la aplicación: información|Información sobre los detalles de la aplicación, la seguridad y el cumplimiento.|
|Panel de la aplicación: conclusiones  
*(cuando proceda)*|Análisis de los datos almacenados en la aplicación, desglosados por tipo de archivo y nivel de uso compartido de archivos.|
...
## <a name="tag-apps-as-sanctioned-or-unsanctioned"></a><a name="sanctionapp"></a>Etiquetado de aplicaciones como autorizadas o no autorizadas
...
- En la lista de aplicaciones, en la fila que contenga la aplicación que quiera marcar como autorizada, elija los tres puntos al final de la fila ![Puntos para marcar como autorizada](media/sanction-three-dots.png "Etiquetado como puntos autorizados") y elija **Marcar como autorizada**.

    ![Marcar como autorizada](media/mark-as-sanctioned.png "etiquetado como autorizado")
...
5. Vaya al **panel de Cloud Discovery** y compruebe los siguientes elementos:
    ...
    - ¿Hay aplicaciones en la nube que se usen pero no cumplan la directiva de su organización?
