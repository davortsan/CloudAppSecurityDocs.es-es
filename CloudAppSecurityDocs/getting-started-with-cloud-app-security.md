...
1. [Integración con Microsoft Defender para punto de conexión](mde-integration.md) para habilitar automáticamente Cloud App Security y supervisar los dispositivos Windows 10 dentro y fuera de la empresa.
